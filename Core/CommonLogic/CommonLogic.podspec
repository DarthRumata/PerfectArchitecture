...
Pod::Spec.new do |s|
  s.name             = 'CommonLogic'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CommonLogic.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GD/CommonLogic'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.author           = { 'Stanislav Kirichok' => 'skirichok@griddynamics.com' }
  s.source           = { :git => 'https://github.com/GD/CommonLogic.git', :tag => s.version.to_s }
