...
Pod::Spec.new do |s|
  s.name             = 'ProductPage'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WLProductInfoPage.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GD/ProductPage'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.author           = { 'Stanislav Kirichok' => 'skirichok@griddynamics.com' }
  s.source           = { :git => 'https://github.com/GD/ProductPage.git', :tag => s.version.to_s }
